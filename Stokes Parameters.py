...
#This code will return a file containing: wavelengths, S0, S1, S2, S3, Polarization Degree, S1/S0, S2/S0, S3/S0, S0-Min, (S0-Min)/Max, abs(S1/S0), abs(S2/S0), abs(S3/S0)
...
#ABSOLS2/S0
S2_S0_abs_lst = [abs(i) for i in S2_S0_lst]                     #ABSOL(S2/S0), ColL: Absolute value of col H

#ABSOLS3/S0
S3_S0_abs_lst = [abs(i) for i in S3_S0_lst]                     #ABSOL(S3/S0), ColL: Absolute value of col I

#5 Create a new file containing the stokes parameters:
new_file = open("stokes_parameters.txt", "w")
new_file.write('Wavelength' + ' ' + 'S0' + ' ' + 'S1' + ' ' + 'S2' + ' ' + 'S3' 
                + ' ' + 'PolDeg' + ' ' + 'S1/S0' + ' ' + 'S2/S0' + ' ' + 'S3/S0' 
                + ' ' + 'S0-Min' + ' ' + 'S0-Min/Max' + ' ' + 'ABSOL(S1/S0)'
                + ' ' + 'ABSOL(S2/S0)' + ' ' + 'ABSOL(S3/S0)' + '\n')
